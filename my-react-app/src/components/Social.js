...
import '../Social.css'; // Assuming this is the correct path to your CSS file
import logo from '../images/image-removebg-preview.png'; // Fix the path and file extension
